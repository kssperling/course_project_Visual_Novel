...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_Characters : CMD_DatabaseExtension
    {
        ...
        private static IEnumerator MoveCharacter(string[] data)
        {
            ...
            //try to get the speed axis position
            parameters.TryGetValue(PARAM_SPEED, out speed);
        ...
        public static IEnumerator ShowAll(string[] data)
        {
            ...
            //Convert the data array to a parameter containter 
            var parameters = ConvertDataToParameters(data);
        ...
        public static IEnumerator HighlightAll(string[] data)
        {
            ...
            if (!immediate)
            {
                ...
                while (characters.Any(c => c.isHighlighting) || (handleUnspecifiedCharacters &&
                    unspecifiedCharacters.Any(uc => uc.isUnHighlighting)))
                {
                    yield return null;
                }
            }
        ...
        public static IEnumerator UnHighlightAll(string[] data)
        {
            ...
            if (!immediate)
            {
                ...
                while (characters.Any(c => c.isUnHighlighting) || (handleUnspecifiedCharacters &&
                    unspecifiedCharacters.Any(uc => uc.isHighlighting)))
                {
                    yield return null;
                }
            }
        ...
        public static IEnumerator SetColor(string[] data)
        {
            ...
            bool specifiedSpeed =
                parameters.TryGetValue(new string[] { "-spd", "-speed" }, out speed, defaultValue: 1f);
        ...
        public static IEnumerator Highlight(string[] data)
        {
            ...
            Character character =
                CharacterManager.instance.GetCharacter(data[0], createIfDoesNotExist: false) as Character;
