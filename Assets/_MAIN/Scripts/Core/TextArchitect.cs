...
public class TextArchitect
{
    ...
    /// <summary>
    /// проявляет текст, который готов в TextArchitect
    /// </summary>
    ...
    IEnumerator Building()
    {
        ...
        switch (buildMethod)
        {
            case BuildMethod.typewriter: 
                yield return Bulid_Typewriter();
                break;
            case BuildMethod.fade:
                yield return Bulid_Fade();
                break;
        }
    ...
    private IEnumerator Bulid_Typewriter()
    {
    ...
    private IEnumerator Bulid_Fade()
    {
